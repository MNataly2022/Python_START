...
Пример: 34/-30/4  2/4/1  -34/0/Точка на отрицательной части оси абсцисс
"""

x = int(input("Введите кoординату точки по оси X "))
y = int(input("Введите кoординату точки по оси Y "))
...
if (x > 0 and y > 0):
    ...
    print("Точка начала системы координат")
